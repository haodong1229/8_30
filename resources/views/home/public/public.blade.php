    ...
    <div id="Head" class="vanclHead">
      ...
      <div class="navlist clear" id="mainNavBox" style="z-index:300!important;">
        <ul>
          ...
          @foreach($s as $ll) 
          <li>
            <a href="" class="track" name="hp-hp-head-nav_1-v:n" target="_blank">{{$ll->tname}}
            ...
            <div class="subNav" style="display: none;*postion:relative;*z-index:300;">
              ...
              <ul>
                @foreach($ll->dev as $xll)
                <li>
                  <a href="" class="track" name="hp-hp-head-nav_1-1-v:n" target="_blank">{{$xll->tname}}</a>
                </li>
                @endforeach
              </ul>
            </div>
